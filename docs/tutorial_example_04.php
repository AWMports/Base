...
{
    static public function findRecursiveCallback( \AWMports\ezcBase\Structs\FileFindContext $context, $sourceDir, $fileName, $fileInfo )
    {
    ...
    static public function findRecursive( $sourceDir, array $includeFilters = array(), array $excludeFilters = array() )
    {
        ...
        \AWMports\ezcBase\File::walkRecursive( $sourceDir, $includeFilters, $excludeFilters,
